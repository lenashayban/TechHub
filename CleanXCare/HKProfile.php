     ...
     <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        ...
        <section>
             ...
             <p class="h_Lable" > Name: <span style="color: black"> <?php echo ($_SESSION['user']); ?> </span> </p> 
               ...
               <p class="h_Lable"> E-mail:  <span style="color: black"> <?php echo ($_SESSION['email']); ?></span></p>
               <p class="h_Lable">Location:  <span style="color: black"> <?php echo ($_SESSION['location']); ?> </span></p>
             <p class="h_Lable"> Hours Price:  <span style="color: black"> <?php echo ($_SESSION['HPrice'])?></span></p>
               <p class="h_Lable"> Service:  <span style="color: black"> <?php echo ($_SESSION['ExpT'])?> </span></p>
               <p class="h_Lable"> Years of experience:  <span style="color: black"> <?php echo ($_SESSION['ExpY'])?> </span></p>
               <?php
               ...
               ?>
                ...
                <div class=" align-items-center justify-content-center text-center">
                    <a class="btn btn-primary btn-xl js-scroll-trigger" href="EditHKProfile.php">Edit Profile</a> 
                </div>
        <br>
          <div class=" align-items-center justify-content-center text-center">
