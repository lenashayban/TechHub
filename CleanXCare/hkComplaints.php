            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                          ...
                          <form action="hkComplaints.php" method="POST">
...
if ($_POST['send'])
{
    ...
    $sql = "INSERT INTO hkcomp(Comp,Status,hkID,Email) VALUES ('$complaint','New','$id','$email')";
    ...
    {   $query="SELECT * FROM admin";
        ...
        $body = "New House Keeper complaint was raised. Check please!";
