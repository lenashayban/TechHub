...
/*-----------END CARDS--------------*/
     ...
     <body id="page-top" class="page-section bg-primary">
        
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" >Applications</a> 
         ...
         <section  id="All">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center marg">
...
<?php
     include ('connection.php');
      ...
      $result = mysqli_query($connection,"SELECT * FROM `hkaccount`");
    ...
    <div class="additional">
      <div class="user-card">
        ...
        <div class="points center">
         ...
         <a   class="approveal" href="ApprovalAction.php?id='<?php echo($acID) ?>'">Approve </a><br>
         <a class="approveal" href="RejectHKRequest.php?id='<?php echo($acID) ?>'"> Disapprove </a>
        </div>
