                ...
                acceptDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(request.getRole().equals("Developer")) {
                            long c = project.getDevelopers() ;
                            System.out.println("project d " + c);
                            if(c > 0) {
                                c--;
                                reference.child("Projects").child(request.getProjectID())
                                        .child("developers").setValue(c);
                        ...
                        if(request.getRole().equals("Tester")) {
                            long c1 = project.getTesters();
                            System.out.println("project t " + c1);
                            if(c1 > 0) {
                                c1--;
                                reference.child("Projects").child(request.getProjectID())
                                        .child("testers").setValue(c1);
                                reference.child("Requests").child(request.getKey())
                                        .child("status").setValue("Accepted");
                                // Update user role
                                mDatabase.child(u.getKey())
                        ...
                        if(request.getRole().equals("Financier")) {
                            ...
                            System.out.println("project f " + c2);
                            if(c2 > 0) {
                                c2--;
                                reference.child("Projects").child(request.getProjectID())
                        ...
                        if(request.getRole().equals("Manager")) {
                            long c3 = project.getManagers() ; //managers
                            System.out.println("project m " + c3);
                            if(c3 > 0) {
                                c3--;
                                reference.child("Projects").child(request.getProjectID())
                                        .child("managers").setValue(c3);
                                reference.child("Requests").child(request.getKey())
                                        .child("status").setValue("Accepted");
                                // Update user role
                                mDatabase.child(u.getKey())
                        ...
                        if(request.getRole().equals("Other role")) {
                            long c4 = project.getOthers() ;// others
                            System.out.println("project o " + c4);
                            if(c4 > 0) {
                                c4--;
                                reference.child("Projects").child(request.getProjectID())
                                        .child("others").setValue(c4);
                                reference.child("Requests").child(request.getKey())
                                        .child("status").setValue("Accepted");
                                // Update user role
                                mDatabase.child(u.getKey())
